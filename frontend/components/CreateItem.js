						...
						>
							...
							<fieldset disabled={loading} aria-busy={loading}>
								<label htmlFor="file">
									...
									{this.state.image && <img src={this.state.image} width="200" alt="upload preview"></img>}
								</label>
								<label htmlFor="title">
									Title
								...
								<label htmlFor="description">
									Description
									<textarea type="text" name="description" id="description" placeholder="Description" required value={this.state.description} onChange={this.handleChange} />
								</label>
